...
import static com.cold.beer.beerstock.utils.JsonConvertionUtils.asJsonString;
...
public class BeerControllerTest {
    ...
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        ...
        mockMvc.perform(post(BEER_API_URL_PATH)
                ...
                .andExpect(jsonPath("$.style", is(beerDTO.getStyle().toString())));
    }
    ...
    void whenGETListWithBeersIsCalledThenOkStatusIsReturned() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(BEER_API_URL_PATH)
                ...
                .andExpect(jsonPath("$[0].style", is(beerDTO.getStyle().toString())));
    }
    ...
    void whenPATCHIsCalledToIncrementDiscountThenOKStatusIsReturned() throws Exception {
        ...
        // when
        when(beerService.updateQuantity(VALID_BEER_ID, quantityDTO.getQuantity())).thenReturn(beerDTO);
    ...
    void whenPATCHIsCalledToIncrementGreaterThanMaxThenBadRequestStatusIsReturned() throws Exception {
        ...
        // when
        when(beerService.updateQuantity(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerStockExceededException.class);
    ...
    void whenPATCHIsCalledWithInvalidBeerIdToIncrementThenNotFoundStatusIsReturned() throws Exception {
        ...
        // when
        when(beerService.updateQuantity(INVALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerNotFoundException.class);
    ...
    void whenPATCHIsCalledToDecrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception {
        ...
        // when
        when(beerService.updateQuantity(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerStockLessThanZeroException.class);
